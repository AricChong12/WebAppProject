        ...
        <div id="content-container">
            ...
            <div id="main">
                ...
                //mysqli_close($conn);
                    ...
                    ?>
                    <label for="ndate">New Date: </label>
                    <input type="date" id="ndate" name="ndate" required><br>

                    <br>

                    <label for="nbloc">New Business Location: </label><br>
                    <textarea id="nbloc" name="nbloc" placeholder="Your New Business Location" required></textarea><br>
                ...
                <?php
                            ...
                            //setcookie("SelectedBusiness", $UserSelectedBusiness, time() + 3600, "/");
                            //$cookie = $_COOKIE["SelectedBusiness"];

                            $sql = "INSERT INTO business_application(BusinessName, Date, BusinessLocation, Type, Status, USER_ID)
                                    VALUES ('$UserSelectedBusiness' ,'$ndate', '$nbloc', 'renewal', 'pending', '$user_id')";
